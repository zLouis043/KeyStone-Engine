...
KS_API void ks_assets_manager_register_asset_type(Ks_AssetsManager am,
                                                  const char *type_name,
                                                  Ks_IAsset asset_interface);

KS_API Ks_AssetHandle ks_assets_manager_load_asset_from_file(
    Ks_AssetsManager am, const char *type_name, const char *asset_name,
...
KS_API void ks_assets_manager_asset_release(Ks_AssetsManager am,
                                            Ks_AssetHandle handle);

KS_API bool ks_assets_is_handle_valid(Ks_AssetsManager am,
                                      Ks_AssetHandle handle);
